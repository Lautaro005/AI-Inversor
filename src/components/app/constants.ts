...
export const TRANSLATIONS: TranslationMap = {
	en: {
		...
		ebitdaLabel: 'EBITDA',
		ebitdaInfo:
			"EBITDA means earnings before interest, taxes, depreciation, and amortization. It's a quick way to see core operating profit before financing and accounting adjustments.",
		downloadReport: 'Download PDF',
		analysisSubtitleFallback: 'Independent automated analysis.',
		valueUnitPrefix: 'Values shown in USD',
		valueUnitUnits: 'units',
		valueUnitThousands: 'thousands',
		valueUnitMillions: 'millions',
		valueUnitBillions: 'billions',
		valueUnitTrillions: 'trillions',
		valMatrixInfo: 'Snapshot that shows how the company trades versus the peer group.',
		peInfo: 'The P/E ratio tells you how much you pay per dollar of earnings. Lower can mean cheaper, higher can mean growth expectations.',
		evInfo: 'EV/EBITDA compares enterprise value with core operating profit before accounting adjustments.',
		psInfo: 'The P/S ratio compares market cap to annual revenue, useful for high-growth firms.',
		valuationMetricFallback: 'Valuation multiple compared with the sector average.',
	...
	es: {
		...
		ebitdaLabel: 'EBITDA',
		ebitdaInfo:
			'EBITDA significa beneficio antes de intereses, impuestos, depreciación y amortización. Resume la rentabilidad operativa pura antes de gastos financieros o ajustes contables.',
		downloadReport: 'Descargar PDF',
		analysisSubtitleFallback: 'Análisis automatizado independiente.',
		valueUnitPrefix: 'Valores expresados en USD',
		valueUnitUnits: 'unidades',
		valueUnitThousands: 'miles',
		valueUnitMillions: 'millones',
		valueUnitBillions: 'miles de millones',
		valueUnitTrillions: 'billones',
		valMatrixInfo: 'Resumen de cómo cotiza la compañía frente a sus pares.',
		peInfo: 'El PER indica cuánto paga el mercado por cada dólar de utilidad. Bajo suele ser más barato; alto implica expectativas de crecimiento.',
		evInfo: 'El EV/EBITDA compara el valor de la empresa con su beneficio operativo antes de ajustes contables.',
		psInfo: 'El P/S relaciona la capitalización bursátil con los ingresos anuales, útil para firmas en rápido crecimiento.',
		valuationMetricFallback: 'Múltiplo de valoración comparado con el promedio sectorial.',
