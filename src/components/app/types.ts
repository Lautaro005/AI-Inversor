...
export interface Translation {
	...
	analysisSubtitleFallback: string;
	valueUnitPrefix: string;
	valueUnitUnits: string;
	valueUnitThousands: string;
	valueUnitMillions: string;
	valueUnitBillions: string;
	valueUnitTrillions: string;
	valMatrixInfo: string;
	peInfo: string;
	evInfo: string;
	psInfo: string;
	valuationMetricFallback: string;
	optValue: string;
	optGrowth: string;
	optBear: string;
	optIncome: string;
